...
import DecisionTree from "@/components/DecisionTree"; // Import the lazy-loaded DecisionTree
        ...
        <div>
          {selectedEdition ? (
            ...
            <div className="bg-white p-6 shadow rounded-lg">
              ...
              <p className="mb-4">
                Ответьте на вопросы в интерактивном графе слева, чтобы получить
                рекомендацию по выбору оптимальной редакции Deckhouse Kubernetes
                Platform.
              </p>
              <p className="mb-4">
                В зависимости от ваших требований, система проанализирует
                доступные опции и порекомендует наиболее подходящую для вас
                лицензию.
              </p>
              ...
              <p>
                После получения рекомендации вы сможете увидеть подробную
                информацию о выбранной редакции и сравнить её с другими.
              </p>
            </div>
          )}
        </div>
